...
export const MESSAGE_PROMPT = "Player 1's stats: {player_1_stats}.\n" +
  ...
  "Attached below are also images of the players' characters and their abilities. " +
  ...
  "To make sure the damage is balanced, the damage should be between -20-20. It can be negative if the ability heals the player.";
