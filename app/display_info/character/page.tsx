    ...
    <div className="flex h-screen min-h-screen flex-col items-center justify-center space-y-8 bg-[#FEFEC8]">
      {info === null ? (
        ...
        <button
          ...
          className={"flex w-80 transform items-center justify-center rounded-xl py-2 text-2xl font-bold text-white shadow-lg transition-transform hover:scale-105 bg-green-500 hover:bg-green-600"}
        >
